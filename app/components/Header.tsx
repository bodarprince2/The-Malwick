...
export default function Header({ variant = "solid" }: HeaderProps) {
  ...
  return (
    <header className={headerClass} id="site-header">
      <Link href="/" className="flex items-center gap-3 no-underline text-[#1a1a1a] z-[101]" aria-label="The Melwick — Home">
        <Image
          src="/logo.png"
      ...
      <div className="flex items-center gap-4 md:gap-6 z-[101]">
        ...
        <div className="flex items-center gap-4 border-l border-[#1a1a1a]/20 pl-4 md:pl-6">
          <Link href="/wishlist" className="relative text-[#1a1a1a] hover:text-[#b8976a] transition-colors" aria-label="Wishlist">
            ...
            {mounted && wishlistItems > 0 && (
              <span className="absolute -top-2 -right-2 bg-[#1a1a1a] text-white text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center scale-in">
                {wishlistItems}
              </span>
            )}
          </Link>
